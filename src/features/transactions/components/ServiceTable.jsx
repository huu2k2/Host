                ...
                <table className="table w-full bg-white shadow rounded border">
                    <thead>
                        <tr>
                            ...
                            <th className="font-normal">Tiền điện</th>
                            <th className="font-normal">Tiền nước</th>
                            <th className="font-normal">Tiền xe</th>
                            <th className="font-normal">Phí wifi</th>
                            <th className="font-normal">máy giặt</th>
                            <th className="font-normal">tủ lạnh </th>
                            <th className="font-normal">Phí wifi</th>


                            <th className="font-normal">Phí dịch vụ</th>
                            <th className="font-normal">Thành tiền</th>
                                ...
                                <div className="font-medium dark:text-white">
                                    ...
                                    <div className="text-sm text-gray-500 dark:text-gray-400">
                                        <div className=" flex gap-3 ">
                                            <div className=" flex ">
                                                <UsersIcon className="w-5 flex " />{"3"}
                                            </div>
                                            <div className=" flex ">
                                                <RiEBikeLine size={20} />{"2"}
                                            </div>
